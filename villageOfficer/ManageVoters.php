...
<div class="container mx-auto p-4" text-left>
    ...
    <form role="form" method="post" name="search" class="mb-4" action="#">
        <div class="flex items-center border-b border-b-2 border-blue-500 py-2">
            <input required type="text" name="searchdata" id="searchdata" placeholder="Search by Name/Mobile No." class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none">
            <button type="submit" name="search" id="submit" class="flex-shrink-0 bg-blue-500 hover:bg-blue-700 border-blue-500 hover:border-blue-700 text-sm border-4 text-white py-1 px-2 rounded">Search</button>
    </div>
</form>
